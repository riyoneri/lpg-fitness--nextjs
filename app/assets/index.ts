...
export { default as story1 } from "./images/story-1.png";
export { default as story2 } from "./images/story-2.png";
export { default as story3 } from "./images/story-3.png";
export { default as story4 } from "./images/story-4.png";
